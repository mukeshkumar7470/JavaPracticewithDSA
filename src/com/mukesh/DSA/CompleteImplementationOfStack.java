...
class StackAll {
    ...
    public void display() {
        if (isEmpty())
            System.out.println("StackAll is empty!");
        else {
...
public class CompleteImplementationOfStack {

    public static void main(String args[]) {
        StackAll stack = new StackAll(5);
        System.out.println("StackAll created.\n");

        if (stack.push(1))
            System.out.println("The element is pushed to the stack!\n");
        else
            System.out.println("StackAll is full!\n");
