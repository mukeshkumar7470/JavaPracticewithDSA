...
public class StackDisplay {
    public static void main(String args[]) {
        StackDisplayClass stack = new StackDisplayClass(5);
        System.out.println("StackDisplayClass created.\n");

        if (stack.push(1))
            System.out.println("The element is pushed to the stack!\n");
        else
            System.out.println("StackDisplayClass is full!\n");
